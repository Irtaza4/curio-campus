...
class EmergencyRequestDetailScreen extends StatefulWidget {
  ...
  @override
  State<EmergencyRequestDetailScreen> createState() => _EmergencyRequestDetailScreenState();
}

class _EmergencyRequestDetailScreenState extends State<EmergencyRequestDetailScreen> {
  ...
  Future<void> _fetchRequestDetails() async {
    ...
    try {
      ...
      _request = await emergencyProvider.fetchEmergencyRequestById(widget.requestId);
    } catch (e) {
      if (mounted) {
  ...
  Future<void> _resolveRequest() async {
    ...
    try {
      final emergencyProvider = Provider.of<EmergencyProvider>(context, listen: false);
      final success = await emergencyProvider.resolveEmergencyRequest(_request!.id);
  ...
  Future<void> _deleteRequest() async {
    ...
    try {
      final emergencyProvider = Provider.of<EmergencyProvider>(context, listen: false);
      final success = await emergencyProvider.deleteEmergencyRequest(_request!.id);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          if (widget.isOwnRequest && _request != null && !_request!.isResolved) ...[
            IconButton(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        // Requester avatar
                        _request!.requesterAvatar != null && _request!.requesterAvatar!.isNotEmpty
                            ? CachedNetworkImage(
                          ...
                          errorWidget: (context, url, error) => CircleAvatar(
                            ...
                            child: Text(
                              _request!.requesterName[0].toUpperCase(),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                widget.isOwnRequest ? 'Your Request' : _request!.requesterName,
                                style: TextStyle(
                                  fontSize: 18,
